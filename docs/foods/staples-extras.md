# Staples, seasonings & extras

**Gluten-free is not the same as slow-carb.** Gluten avoidance addresses intolerance or coeliac disease; the slow-carb grain and fruit exclusions are author rules, not medical necessities for weight loss. Keep those questions separate when choosing foods. See [sources and scope](../sources.md).

## Familiar staples: what changes?

| Food | Six strict days / practical alternative |
| --- | --- |
| Rice, brown rice, poha/aval/atukulu, puffed rice, rice noodles | Leave out as grain staples; use vegetables alongside a substantial pulse serving. |
| Wheat, atta, maida, sooji/rava, bulgur, barley, rye | Leave out; these also contain gluten. “Rava” can describe other grains, so identify its source. |
| Oats, quinoa, amaranth seed, buckwheat | Leave out as grain or grain-like staples under this framework, even when gluten-free. Amaranth **leaves** remain vegetables. |
| All millets and sorghum | Leave out: ragi/finger millet/kezhvaragu/ragulu; bajra/pearl millet/kambu/sajjalu; foxtail/thinai/korralu; little/samai/samalu; kodo/varagu/arikelu; barnyard/kuthiraivali/oodalu; proso/panivaragu/varigalu; sorghum/jowar/cholam/jonnalu. |
| Gluten-free bread, pasta, pizza, crackers | Not strict-day substitutes: commonly based on rice, corn, potato or tapioca starch. Check specialty pulse products individually. |
| Conventional idli, dosa, appam, idiyappam | Rice-based versions stay out; fermentation does not remove their rice or make gluten-containing grains safe. |
| Rice-free all-pulse adai or pesarattu | Practical adaptation: use pulses, vegetables and spices with no rice, millet, semolina or starch binder. Restaurant pesarattu may contain rice or arrive with upma. |
| Besan/chickpea-flour chilla | Practical adaptation, not unlimited snack permission. Choose plain gluten-free flour; include vegetables and assess the actual pulse portion. |
...
!!! warning "Hing and spice blends need a label check"
    Compounded asafoetida/hing/perungayam/inguva often uses **wheat flour**. Choose a clearly gluten-free product. Check sambar powder, rasam powder, masala mixes, stock, soy sauce and chutneys for gluten, milk ingredients and added sugar. Shared mills, utensils and fryers are separate cross-contact risks; a simple ingredient list alone is not a gluten-free guarantee.

Default to dairy-free cooking rather than butter, ghee, cream, curd or paneer. Lactose content varies; do not assume “traditional” or “clarified” means suitable for everyone.
