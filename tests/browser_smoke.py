...
with sync_playwright() as playwright:
    ...
    page.get_by_role("link", name="Chipotle & CAVA orders", exact=True).click()
    expect(page.locator(".restaurant-card")).to_have_count(2)
    expect(page.locator(".restaurant-card").first).to_contain_text("No sofritas")
    expect(page.locator(".restaurant-card").last).to_contain_text("black lentils")
    ...
    expect(mobile.locator(".restaurant-card")).to_have_count(2)
    check_layout(mobile)
